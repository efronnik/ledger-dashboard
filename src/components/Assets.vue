...
<template>
  <div class="bg-white rounded-xl shadow p-4 w-full max-w-3xl border border-gray-200">
    ...
    <!-- Loading -->
    <div v-if="isLoading" class="flex items-center justify-center py-8 text-gray-500">
      🔄 Loading assets...
    </div>
    ...
    <div v-else class="space-y-3">
      ...
      >
        ...
        <div class="text-right w-1/5 min-w-[80px]">
          <p class="font-mono text-sm truncate">{{ asset.amount?.toFixed(6) }}</p>
        ...
        >
          <p class="font-mono text-sm">{{ asset.price_change_percentage_24h.toFixed(2) }}%</p>
